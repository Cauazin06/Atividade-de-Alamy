...
public class Agenda {
    ...
    public static void main(String[] args) {
        ...
        agenda.addContatinho(new Contatinho("Roberto", "roberto@gmail.com", "75333333", "Chefe"));
        agenda.addContatinho(new Contatinho("Romilda", "romilda@gmail.com", "55555555", "Amiga"));
        agenda.addContatinho(new Contatinho("Arthur", "arthur@gmail.com", "77774444", "Irmão"));

        agenda.salvarLista();

        Contatinho c = agenda.buscarContatinho("Arthur");
